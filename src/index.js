function getSVG() {
    ...
    const toNodes = new DOMParser().parseFromString(svgString,'text/html').body.childNodes;

    console.log('toNodes',toNodes);
    // let group = toNodes.getElementsByTagName('g');
    console.log(toNodes.length);
    return toNodes[0];
}
